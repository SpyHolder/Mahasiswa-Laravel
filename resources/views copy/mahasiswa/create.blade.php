    ...
    <div class="card-body p-3">
        <form action="" method="">
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="staticEmail" name="">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-3">
                    <input type="date" class="form-control" id="inputPassword" name="">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="inputNilai" name="">
                </div>
            </div>
            <div class="mb-3 row">
