                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="{{route('mahasiswa.index')}}">List Mahasiswa</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownJurusan">
                                    <li><a class="dropdown-item" href="{{route('jurusan.index')}}">List Jurusan & Semester</a></li>
                                    <li><a class="dropdown-item" href="{{route('jurusan.create')}}">Tambah Jurusan</a></li>
                                    <li><a class="dropdown-item" href="{{route('semester.create')}}">Tambah Semester</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
